...
import { DxChart, DxSeries, DxLegend, DxCommonPaneSettings, DxSize } from 'devextreme-vue/chart';
...
const chartAttributes = { class: 'chart-class' };
</script>
<template>
  <div class="chart-wrapper">
    ...
    >
      ...
      <DxCommonPaneSettings background-color="url(#Background)"/>
    </DxChart>
    <svg class="svg-patterns">
      <defs>
        ...
        >
          <stop
            offset="40%"
            stop-color="rgba(0, 174, 239, .5)"
          />
          <stop
            offset="80%"
            stop-color="rgb(3, 138, 255)"
            stop-opacity="0.2"
          />
        </linearGradient>
      </defs>
